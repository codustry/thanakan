...
from thanakan import SlipQRData, SCBBaseURL, SCBAPI
...
uploaded_file = st.file_uploader("Upload a QR Code bank slip", type=['png', 'jpg', 'jpeg'], accept_multiple_files=False, help=None, on_change=None, args=None, kwargs=None)

if uploaded_file is not None:
    img = Image.open(uploaded_file)
    s = SlipQRData.create_from_image(img)
    out = run( scb_api.verify_slip(
